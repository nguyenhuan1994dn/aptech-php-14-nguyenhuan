          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header d-flex">
                        <a href="#">BLOG</a>/<p href="#">POST</p>
                </div>
                    <div class = "card-body p-0">
                        <?php
                        echo '<h4 class="card-title text-uppercase">'.$arr['title'].  '</h4>
                        <p>By winston on Wednesday, November 1, 2017 5:54 AM</p>
                        <h5>'.$arr['title'].'</h5>';
                        ?>
                     </div>
                    <?php
                    echo '<img src=" ' .$domain .$arr['images'][0]['path']. ' " alt="Mini front end shot" class="card-image img-fluid w-100">';                   
                    ?>
